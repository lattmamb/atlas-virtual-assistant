...
const UniverseNavBar: React.FC<UniverseNavBarProps> = ({ currentSection }) => {
  ...
  const navItems = [
    { id: 'vision', label: 'Vision Pro', icon: <Apple className="h-4 w-4" />, path: '/applevisionpro' },
    { id: 'universe', label: 'U-N-I-Verse', icon: <Sparkles className="h-4 w-4" />, path: '/universe' },
    { id: 'chat', label: 'Chat Room', icon: <MessageSquare className="h-4 w-4" />, path: '/chatroom' },
    { id: 'link', label: 'Atlas Link', icon: <Sparkles className="h-4 w-4" />, path: '/atlaslink' },
